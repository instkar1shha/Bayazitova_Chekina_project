...
namespace OPBDSHKA
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Логин должен содержать не более 50 символов.", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            // Проверка на длину пароля
            if (passUSER.Length > 50)
            {
                MessageBox.Show("Пароль должен содержать не более 50 символов.", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
